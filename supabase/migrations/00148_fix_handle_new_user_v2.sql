...
EXCEPTION WHEN OTHERS THEN
  -- Just log the error to the database so we can see it if possible
  -- But return NEW so we don't block auth user creation
  RETURN NEW;
END;
$function$;
